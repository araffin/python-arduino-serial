...
latex_documents = [
    (master_doc, 'RobustArduinoSerialProtocol.tex', 'Robust Arduino Serial Protocol Documentation',
...
man_pages = [
    (master_doc, 'robustarduinoserialprotocol', 'Robust Arduino Serial Protocol Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'RobustArduinoSerialProtocol', 'Robust Arduino Serial Protocol Documentation',
     author, 'RobustArduinoSerialProtocol', 'One line description of project.',
     'Miscellaneous'),
]
