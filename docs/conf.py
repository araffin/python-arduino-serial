...
latex_documents = [
    (
        master_doc,
        "RobustArduinoSerialProtocol.tex",
...
man_pages = [(master_doc, "robustarduinoserialprotocol", "Robust Arduino Serial Protocol Documentation", [author], 1)]
